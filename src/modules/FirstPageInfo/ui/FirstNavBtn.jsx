...
export const FirstNavBtn =()=>{
    return(
        ...
        <div className="hover:shadow-md transition-all duration-300 flex gap-x-2 border border-gray-200 px-9 py-6 text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:text-gray-700 rounded-b-lg border-t-0 md:rounded-r-lg md:rounded-bl-none md:border-l-0 md:border-t cursor-pointer">
          Profile
        </div>
      </div>
    )
