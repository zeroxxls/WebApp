...
export const HeroSection=()=>{
    return(
        ...
        <div className="relative z-10 flex items-center h-full w-full">
          <div className="mx-auto px-4 text-white flex-col items-center justify-center">
            <Logo/>
            <div className="mt-5 flex flex-col md:h-[72px] md:w-[460px] md:flex-row">
              <a className="flex gap-x-2 border border-gray-200 px-9 py-6 text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:text-gray-700 rounded-t-lg border-b-0 md:rounded-l-lg md:rounded-tr-none md:border-b md:border-r-0 cursor-pointer">
                Explore
              </a>
